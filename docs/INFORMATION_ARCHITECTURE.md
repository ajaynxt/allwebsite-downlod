...
| Surface | Role | Primary links out |
|---|---|---|
| Home | Downloader and value proposition | Supported sites, support, legal pages |
| Supported sites | Compatibility and honest limits | Downloader, legal pages |
| Privacy | Data handling | Home, terms, copyright |
